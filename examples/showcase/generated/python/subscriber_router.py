...
# Extend in your own module (e.g. Subscriber_extra.py) — nothing imports it for you.
"""GENERATED — REST router for Subscriber entity. Implements the cross-port API contract.

Auth: these endpoints are unauthenticated. To guard them, include the router with a
