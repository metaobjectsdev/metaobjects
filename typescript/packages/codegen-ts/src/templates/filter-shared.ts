...
/**
 * Returns true if the given MetaModel child should be included in sort operations.
 *
 ...
 */
export function isSortableField(field: MetaModel): boolean {
...
/**
 * Returns all sortable field children of the given entity MetaModel.
 */
export function sortableFields(entity: MetaModel): MetaModel[] {
