...
<ItemGroup>
  <PackageReference Include="MetaObjects"          Version="0.15.9" />
  <PackageReference Include="MetaObjects.Codegen"  Version="0.15.9" />
  <PackageReference Include="MetaObjects.Render"   Version="0.15.9" />
</ItemGroup>
```
