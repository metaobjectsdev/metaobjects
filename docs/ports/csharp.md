...
<ItemGroup>
  <PackageReference Include="MetaObjects"          Version="0.11.1" />
  <PackageReference Include="MetaObjects.Codegen"  Version="0.11.1" />
  <PackageReference Include="MetaObjects.Render"   Version="0.11.1" />
</ItemGroup>
```
