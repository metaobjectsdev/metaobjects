...
|---|---|---|---|---|---|---|
| [`fixtures/conformance/`](../fixtures/conformance/) (metamodel) | 330 | ✓ | ✓ | inherits via `metadata-ktx` | ✓ | ✓ |
...
| [`fixtures/api-contract-conformance/`](../fixtures/api-contract-conformance/) | 59 (30 core + 9 tph + 9 m2m + 2 jsonb + 2 write-through + 7 projection) | ✓ (Fastify reference + generated lane) | ✓ (embedded HTTP + JDBC) | ✓ (embedded HTTP + Exposed) | ✓ (HttpListener + Npgsql) | ✓ (FastAPI + pg8000) |
...
### `fixtures/api-contract-conformance/` (59)

All 59 scenarios → [features/api-contract.md](features/api-contract.md) (cross-port
...
+ render 15 + persistence 33 + api-contract 59 + source-resolution 25 + scope 10 +
