...
**TypeScript reference implementation** is **published to npm at `0.12.4`** (all 13 `@metaobjectsdev/*` publish candidates on the `latest` tag, full lockstep). C# at `0.11.1` (NuGet); Python at `0.12.0` (PyPI); Java / Kotlin at `7.4.1` (Maven Central). 2500+ tests passing across the workspace.
