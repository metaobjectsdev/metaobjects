...
**TypeScript reference implementation** is **published to npm at `0.11.5`** (all 13 `@metaobjectsdev/*` publish candidates on the `latest` tag, full lockstep). C# / Python at `0.11.1` (NuGet / PyPI); Java / Kotlin at `7.4.1` (Maven Central). 2500+ tests passing across the workspace.
