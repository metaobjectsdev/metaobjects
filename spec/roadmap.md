...
| FR-041 | Public A/B drift benchmark — coding agents with vs without MetaObjects, pre-registered, friction-first | 📋 designed | 1.x | — |
| FR-042 | First-touch positioning — one typed model, three verbs (README, llms, sites) | 📋 designed | — | — |
