...
/// <summary>
/// Null-safe coercions from a <see cref="ExtractionOutcome"/> data map onto typed record components.
/// Generated extract(…) calls use these helpers.
/// </summary>
public static class ExtractMap
{
    ...
    /// <summary>Shared scalar-array reader: a extracted value is a <c>List&lt;object?&gt;</c> (else null); map each element.</summary>
