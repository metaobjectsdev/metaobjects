...
{
    /// <summary>The 15 shared provider-definition file names (keep in lockstep with <c>spec/metamodel/</c>).</summary>
    ...
    /// <summary>
    /// Load + parse the 15 embedded <c>spec/metamodel/*.json</c> files off this
