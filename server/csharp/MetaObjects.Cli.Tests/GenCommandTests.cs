...
public sealed class GenCommandTests : IDisposable
{
    ...
    {
        var outcome = GenSuite.Run(MetaDir, OutDir, "Acme.Generated");
    ...
    public void Gen_baseline_adopt_records_without_writing()
    {
        ...
        Assert.True(GenSuite.Run(MetaDir, OutDir, "Acme.Generated").Ok);
        ...
        var outcome = GenCommand.Run(
            ...
            emitAbstractShapes: false, generatorNames: GenSuite.Names, templateRoot: null,
