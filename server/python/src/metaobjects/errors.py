...
class ErrorCode(str, Enum):
    ...
    ERR_DEPENDENCY_OVERLAY_IMPLICIT = "ERR_DEPENDENCY_OVERLAY_IMPLICIT"
    ...
    ERR_DEPENDENCY_SCHEMA_NOT_OWNED = "ERR_DEPENDENCY_SCHEMA_NOT_OWNED"
    ...
    ERR_DEPENDENCY_BREAKING_CHANGE = "ERR_DEPENDENCY_BREAKING_CHANGE"
