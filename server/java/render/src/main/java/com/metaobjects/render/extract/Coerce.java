...
public final class Coerce {
    ...
    public static Object value(String raw, FieldSpec spec, ExtractOptions opts, String fieldPath, ExtractionReport report) {
    ...
    private static Object coerceEnum(String raw, FieldSpec spec, ExtractOptions opts,
                                     String path, ExtractionReport report, boolean ci) {
