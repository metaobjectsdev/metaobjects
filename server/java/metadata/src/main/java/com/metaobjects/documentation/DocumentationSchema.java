...
public final class DocumentationSchema {
    ...
    public static final List<CommonDocAttr> COMMON_DOC_ATTRS = List.of(
        new CommonDocAttr(
            ...
            false,
            "What this element IS and COVERS, written for someone using it. Markdown allowed, "
        ...
        new CommonDocAttr(
            ...
            StringAttribute.SUBTYPE_STRING,
            false,
            "Short single-line SENTENCE (OpenAPI `summary` pattern) — used in index tables, sidebar "
        ...
        new CommonDocAttr(
            ...
            StringAttribute.SUBTYPE_STRING,
            false,
            "Short single-line human label — a NOUN PHRASE naming the element (e.g. 'Email' for a "
        ...
        new CommonDocAttr(
            ...
            StringAttribute.SUBTYPE_STRING,
            false,
            "Internal-only rationale, never emitted to user-facing docs — the slot for what you had to "
