...
public class TypeDefinitionBuilder {
    ...
    /**
     * Set the FR-033 rules prose (optional).
     *
     * @param rules Documentation of the complex rules enforced in code
     * @return This builder for method chaining
     */
    public TypeDefinitionBuilder rules(String rules) {
        this.rules = rules;
        return this;
    }

    /**
     * Set the FR-033 example (optional).
     *
     * @param example An example for this type/subType
     * @return This builder for method chaining
     */
    ...
    /**
     * Set the FR-033 when-to-use guidance (optional).
     *
     * @param whenToUse Guidance on when to reach for this type/subType
     * @return This builder for method chaining
     */
    public TypeDefinitionBuilder whenToUse(String whenToUse) {
        this.whenToUse = whenToUse;
        return this;
    }

    /**
     * Set the FR-033 child-side placement claim ({@code parents}) (optional).
     *
     * @param parents The parent type/subTypes this type may be placed under
     * @return This builder for method chaining
     */
    public TypeDefinitionBuilder parents(List<String> parents) {
    ...
    /**
     * Add an optional attribute carrying an FR-033 doc description (the per-attr
     * human/AI-facing prose the manifest emits). Additive over
     * {@link #optionalAttribute(String, String)} — same placement behavior; the
     * description rides the {@link ChildRequirement}. Sub-step B sources the text
     * from the embedded {@code spec/metamodel/*.json}.
     *
     * @param attrName Attribute name
     * @param attrSubType Attribute subType (e.g., "string", "boolean", "int")
     * @param docDescription FR-033 doc description (can be null)
     * @return This builder for method chaining
     */
    public TypeDefinitionBuilder optionalAttribute(String attrName, String attrSubType, String docDescription) {
        // Mirror optionalAttribute(name, subType): add the ChildRequirement (now
        // carrying the doc description) AND auto-generate the matching placement
        // constraint, keeping behavior identical apart from the carried prose.
        ChildRequirement requirement = new ChildRequirement(
            attrName, "attr", attrSubType, false,
            null, null, null, null, null, docDescription);
        addChildRequirement(requirement);
