  ...
  "types": [
    {
      "type": "object",
      "subType": "base",
      "description": "Abstract object base — the shared root subtype that concrete object subtypes (entity/value/projection) specialize. Carries the discriminator attrs common to every object but has no runtime semantics of its own; not authored directly.",
      "children": [
        {
          "type": "attr",
          "subType": "string",
