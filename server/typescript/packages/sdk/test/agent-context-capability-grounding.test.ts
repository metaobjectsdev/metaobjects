...
const CODE_IDENTIFIERS_NOT_METAMODEL_ATTRS = new Set<string>([
  ...
  "@Valid",           // Jakarta Bean Validation annotation, named in the audit skill's
                      //   field.map rung when explaining that per-field validateValue
                      //   does not cascade it on Java TPH write paths (#362)
]);
