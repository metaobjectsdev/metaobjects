...
- \`db\` — your Drizzle connection — the generated queries take \`db: Db\` (a \`NodePgDatabase\` / \`BaseSQLiteDatabase\` alias). Construct one over your own driver and pass any compatible Drizzle instance:
